...
button::button(const std::string &text, ALLEGRO_BITMAP *img, ALLEGRO_FONT *font, ALLEGRO_COLOR *color, const double animation_time):
...
button::button(ALLEGRO_BITMAP *img, ALLEGRO_FONT *font, ALLEGRO_COLOR *color, const double animation_time):
    button("", img, font, color, animation_time)
{}

button::button(const std::string &text, ALLEGRO_FONT *font, ALLEGRO_COLOR *color, const double animation_time):
    button(text, nullptr, font, color, animation_time)
{}
...
{
    label::update();
    if (mouse_over_ && press_state_==0 && !mouse.leftPressed())
